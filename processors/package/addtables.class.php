        ...
        foreach ($tables as $tableIndex => $table) {
            ...
            if ($fieldsStmt) {
                ...
                if ($manager->xpdo->getDebug() === true) {
                    $manager->xpdo->log(xPDO::LOG_LEVEL_DEBUG, print_r($fields, true));
                }
            ...
            if ($indexesStmt) {
                ...
                if ($manager->xpdo->getDebug() === true) {
                    $manager->xpdo->log(xPDO::LOG_LEVEL_DEBUG, "Indices for table {$table[0]}: " . print_r($indexes, true));
                }
                ...
                if (!empty($indexes)) {
                    ...
                    if ($object) {
                        ...
                        foreach ($indices as $index) {
                            // Index and columns
                            if ($manager->xpdo->getDebug() === true) {
                                $manager->xpdo->log(xPDO::LOG_LEVEL_DEBUG, "Details of index: " . print_r($index, true));
                            }
