		...
		},
		{
            ...
            items: [{
                ...
                items: [
					{
						...
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.relation_type"),
						name: 'relation_type',
						hiddenName: 'relation_type',
						id: '{$gridClass|lower}-relation_type',
						anchor: '90%',
						emptyText: _("{$cmpNamespace}.{$gridClass|lower}.relation_type_empty"),
						allowBlank: false,
						listeners: {
					...
					{
						xtype: 'textfield',
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.alias"),
						name: 'alias',
					...
					{
						xtype: 'textfield',
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.local"),
						name: 'local',
					...
					{
						xtype: 'textfield',
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.cardinality"),
						name: 'cardinality',
                ...
                items: [
					...
					{
						xtype: 'textfield',
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.foreign"),
						name: 'foreign',
					...
					{
						xtype: 'textfield',
						fieldLabel: _("{$cmpNamespace}.{$gridClass|lower}.owner"),
						name: 'owner',
